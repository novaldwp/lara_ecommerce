...
@section('title')
    Jual Aneka {{ $currentChild->name }} Terlengkap Dari Merk Terbaik | Toko Putra Elektronik
@endsection
...
<div class="breadcrumb-wrap">
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{ $currentParent->name }}</a></li>
            <li class="breadcrumb-item active">{{ $currentChild->name }}</li>
        </ul>
    </div>
</div>
<!-- Breadcrumb End -->
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset($product->productimages->thumb.$product->productimages->image1) }}" loading="lazy" alt="{{ $product->name }}" width="300" height="300">
                                </a>
                                @role('customer')
