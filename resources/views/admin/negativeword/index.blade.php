                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="page__heading">Daftar Kata Negatif</h4>
                            <a href="{{ route('admin.analyst.negative-words.create') }}" class="btn btn-success">Tambah Baru</a>
                            &nbsp;
                            <a href="#" class="btn btn-info" name="fake-import">Import</a>
                            &nbsp;
                            <input type="file" name="import" id="" hidden>
                            <a href="{{ route('admin.analyst.negative-words.export') }}" class="btn btn-primary">Export</a>
                        </div>
                        <div class="card-body">
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        serverSide: true,
        ajax:  {
            url: "{{ route('admin.analyst.negative-words.index') }}",
            type: "GET",
            data: function(d) {
                d.filter = filter;
            }
    ...
    $(document).on('click', '#restoreButton', function(e) {
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: 'negative-words/restore/'+word_id,
                    type: 'GET',
                    dataType: 'JSON',
                    success: function(res, textStatus)
                    {
