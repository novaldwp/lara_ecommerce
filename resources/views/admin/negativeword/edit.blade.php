    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form class="needs-validation" method="POST" action="{{ route('admin.analyst.negative-words.update', simple_encrypt($negativeWord->id)) }}" novalidate="">
                            @csrf
                            @method('PUT')
                            <div class="card-header">
                                <h4>Ubah Kata Negatif</h4>
                            </div>
                            <div class="card-body">
                                @if (session('error'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('word') is-invalid @enderror" name="word" value="{{ $negativeWord->word }}" required="">
