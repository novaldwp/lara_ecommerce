                ...
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a href="{{ route('ecommerce.profile.orders') }}" class="nav-link {{ request()->segment(2) == "orders" ? "active":""}}" id="orders-nav"><i class="fa fa-shopping-bag"></i>Riwayat Order</a>
                    <a href="{{ route('ecommerce.profile.account') }}" class="nav-link {{ request()->segment(2) == "account" ? "active":""}}" id="account-nav"><i class="fa fa-user"></i>Biodata Diri</a>
